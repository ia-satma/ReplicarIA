                                                  ...
                                                  <div className="flex flex-wrap items-center gap-2">
                                                    {project.project_id && (
                                                      <Link
                                                        ...
                                                        className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-[#34C759] text-[#021423] rounded-lg text-sm font-medium hover:bg-[#2CB24E] transition-colors min-h-[44px]"
                                                      >
                                                        <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        {bitacoraLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#34C759] text-[#021423] rounded-lg hover:bg-[#2CB24E] text-sm font-medium transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>

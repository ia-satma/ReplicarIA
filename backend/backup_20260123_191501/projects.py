...
async def get_current_user_for_projects(credentials: HTTPAuthorizationCredentials = Depends(security)):
    """Verify user is authenticated for project operations"""
    if not credentials:
...
async def list_projects():
    """Listar todos los proyectos con deliberaciones - filtrado por empresa"""
    from services.defense_file_service import defense_file_service

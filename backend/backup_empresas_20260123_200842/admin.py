    ...
    try:
        ...
        return {
            ...
            "empresa": {
                ...
                "fecha_alta": empresa.fecha_alta.isoformat() if hasattr(empresa.fecha_alta, 'isoformat') else str(empresa.fecha_alta)
            }
        }
    except HTTPException:
        raise
    ...
    try:
        ...
        return {
            ...
            "empresa": {
                ...
                "nombre": updated.nombre_comercial if updated else None
            }
        }
    except HTTPException:
        raise
    except Exception as e:
        logger.error(f"Error updating empresa {empresa_id}: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_empresa_documentos(empresa_id: str, admin_user = Depends(get_admin_user)):
    ...
    try:
        ...
        logger.error(f"Error getting documentos for empresa {empresa_id}: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def upload_kb_document(
    ...
    try:
        ...
        logger.error(f"Error uploading KB documents: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def reindex_kb(empresa_id: str, admin_user = Depends(get_admin_user)):
    ...
    try:
        ...
        logger.error(f"Error reindexing KB for empresa {empresa_id}: {e}")
        raise HTTPException(status_code=500, detail=str(e))
